...
function Login({email,setEmail, password, setPsd, isSecure, setSecure, setIsLogin, isLogin, isReset, setIsReset}){
  ...
  return(
    ...
    >
      ...
      >
        <MyTextInput icon='mail' label='Email' placeholder='johndoe@gmail.com' onChangeText={handleChange('email')}/>
        <MyTextInput icon='key' label='Password' isSecure={isSecure} secureTextEntry={isSecure} onChangeText={handleChange('password')} setSecure={setSecure} placeholder='password'/>
        <View>
          <TouchableOpacity 
            style={{
              alignItems:'center',
